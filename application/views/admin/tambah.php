...
<head>
    ...
    <title>Pintar Literasi | Detail</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="<?= base_url('assets/') ?>images/favicon.ico">

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/core/libs.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/font-awesome/css/all.css') ?>">


    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/hope-ui.min.css?v=4.0.0">

    <!-- Custom Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/custom.min.css?v=4.0.0">

    <!-- Dark Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/dark.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/css/admin.css') ?>">

    <!-- Customizer Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/customizer.min.css">

    <!-- RTL Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>css/rtl.min.css">

    <link rel="stylesheet" href="<?= base_url('assets/boot/css/bootstrap.min.css') ?>">
...
<body class="  ">
            ...
            <a class="navbar-brand">
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                        <img src="<?= base_url('assets/images/ikon.png') ?>" width="50px">
                    </div>
                    <div class="logo-mini">
                        <img src="<?= base_url('assets/images/ikon.png') ?>" width="50px">
                    </div>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active " href="<?= base_url('buku') ?>">
                                    <i class="icon">
                                    ...
                                    <span class="item-name active"> Table </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button"
                            ...
                            <i class="right-icon">
                                <svg class="icon-18" xmlns="http:/w3.org/2000/svg" width="18" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7" />
                                </svg>
        ...
        <div class="position-relative iq-banner">
            ...
            <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <a href="../../dashboard/index.html" class="navbar-brand">
                        ...
                        <div class="logo-main">
                            <div class="logo-normal">
                                <img src="<?= base_url('assets/images/ikon.png') ?>" width="40px">
                            </div>
                            <div class="logo-mini">
                                <img src="<?= base_url('assets/images/ikon.png') ?>" width="40px">
                            </div>
                        ...
                        <h4 class="logo-title">Literasi Pintar</h4>
                    </a>
                    <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                        <i class="icon">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                                    ...
                                    <img src="<?= base_url('assets/images/indo.png') ?>"
                                    ...
                                    <div class="m-0 border-0 shadow-none card">
                                        <div class="p-0 ">
                                            <ul class="p-0 list-group list-group-flush">
                                                <li class="iq-sub-card list-group-item"><a class="p-0" href="#">
                                                        <img src="<?= base_url('assets/images/indo.png') ?>"
                                                ...
                                                <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img
                                                            src="<?= base_url('assets/images/indo.png') ?>"
                                                            alt="img-flaf" class="img-fluid me-2"
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="<?= base_url('assets/images/nabil.jpg') ?>" alt="User-Profile"
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        ...
                                        <small class="main-title">
                                            <?= isset($user['email']) ? ($user['email']) : 'Tidak ada nama'; ?>
                                        </small>
                                    </div>
                                </a>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="lokasi" id="dateText">Mengambil informasi lokasi...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="iq-header-img">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/1.jpg" alt="header"
                        class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/smg.jpg" alt="header"
                        class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/dirga.jpg" alt="header"
                        class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/toler.jpg" alt="header"
                        class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/makan.jpg" alt="header"
                        class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('assetsAdmin/') ?>images/dashboard/sekolah.jpg" alt="header"
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form-wizard1" class="mt-3 text-center" action="<?= base_url('buku/simpan') ?>"
                                    ...
                                    <ul id="top-tab-list" class="p-0 row list-inline">
                                        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
                                            <a>
                                                ...
                                                <span class="dark-wizard">Judul Buku</span>
                                            </a>
                                        </li>
                                        <li id="personal" class="mb-2 col-lg-3 col-md-6 text-start">
                                            <a>
                                                ...
                                                <span class="dark-wizard">Penulis</span>
                                            </a>
                                        </li>
                                        <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
                                            <a>
                                                ...
                                                <span class="dark-wizard">Sampul</span>
                                            </a>
                                        </li>
                                    ...
                                    <fieldset>
                                        <div class="form-card text-start">
                                            <div class="row">
                                                <div class="col-7">
                                                    <h3 class="mb-4">Informasi Buku:</h3>
                                                </div>
                                                <div class="col-5">
                                            ...
                                            <div class="row">
                                                <div class="">
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="text-danger judul">Judul wajib di isi!!</small>
                                                        <small class="text-success judul-done"
                                                            style="display: none;">Judul terisi</small>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="Kategori" required>
                                                        ...
                                                        <option value="Pengembang Diri">Pengembangan Diri</option>
                                                        <option value="Lain-lain">Lain-lain</option>
                                                    </select>

                                                    <small class="text-danger kategori">Kategori Wajib Di
                                                        Pilih!</small>
                                                    <small class="text-success kategori-done"
                                                        style="display: none;">Kategori sudah di pilih</small>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Jumlah Halaman</label>
                                                    <input type="text" class="form-control" name="JumlahHalaman"
                                                        required pattern="[0-9]+" title="Masukan angka!!!">
                                                    <div class="invalid-feedback">
                                                        Masukan angka!
                                                    </div>
                                                    <small class="text-danger jumlahhalaman">Jumlah Halaman Wajib Di
                                                        Isi!</small>
                                                    <small class="text-success jumlahhalaman-done"
                                                        style="display: none;">Jumlah Halaman sudah di isi</small>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-danger bahasa">Bahasa buku Wajib Di Isi!</small>
                                                    <small class="text-success bahasa-done"
                                                        style="display: none;">Bahasa Buku sudah di isi</small>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Jumlah Buku</label>
                                                    <input type="text" class="form-control" name="JumlahBuku" required
                                                        pattern="[0-9]+" title="Masukan angka!!!">
                                                    <div class="invalid-feedback">
                                                        Masukan angka!
                                                    </div>
                                                    <small class="text-danger jumlahbuku">Jumlah Buku Wajib Di Isi
                                                        Dengan
                                                        Angka!</small>
                                                    <small class="text-success jumlahbuku-done"
                                                        style="display: none;">Jumlah Buku sudah di isi</small>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-primary next float-end"
                                            value="submit">Lanjut</button>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-card text-start">
                                            <div class="row">
                                                <div class="col-7">
                                                    <h3 class="mb-4">Informasi Penulis:</h3>
                                                </div>
                                                <div class="col-5">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-danger penulis">Penulis wajib di isi!!</small>
                                                    <small class="text-success penulis" style="display: none;">Penulis
                                                        sudah di isi</small>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-danger penerbit">Penerbit wajib di isi!!</small>
                                                    <small class="text-success penerbit-done"
                                                        style="display: none;">Penerbit sudah di isi</small>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-danger tahunterbit">Tahun Terbit wajib di isi
                                                        dengan angka!!</small>
                                                    <small class="text-success tahunterbit-done"
                                                        style="display: none;">Tahun Terbit sudah di isi</small>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" name="next"
                                            class="btn btn-primary next action-button float-end"
                                            value="Next">Lanjut</button>
                                        <button type="button" name="previous"
                                            class="btn btn-dark previous action-button-previous float-end me-1"
                                            value="Previous">Sebelumnya</button>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-card text-start">
                                            <div class="row">
                                                <div class="col-7">
                                                    <h3 class="mb-4">Tambah Sampul Buku:</h3>
                                                </div>
                                                <div class="col-5">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title fw-semibold">Sampul</h5>
                                                <div class="row">
                                                    <div class="col-12 col-md-1 col-lg-4 col-xl-3 mb-3 p-3">
                                                        <label for="cover" class="d-block" style="cursor: pointer;">
                                                            <div
                                                                ...
                                                                <img id="preview"
                                                                    src="<?= base_url('assets/images/buku.jpg') ?>"
                                                                    alt="Preview" height="300" class="z-1"
                                                    ...
                                                    <div class="col-12 col-md-6 col-lg-8 col-xl-9">
                                                        <div class="mb-3">
                                                            <label class="form-label">Gambar sampul buku</label>
                                                            <input class="form-control" type="file" id="sampul"
                                                                name="sampul" required onchange="previewImage()">
                                                            <div class="invalid-feedback">
                                                            </div>
                                                        </div>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <br><br>
                                            <h4>jika anda terus berada di halaman ini berarti buku gagal di tambahkan
                                            </h4>
                                            <span class="text-danger">pastikan semua form terisi dengan benar!!</span>
                                            <br>
                                            <div class="row justify-content-center">
                                                <div class="col-3"> <img
                                                        src="<?= base_url('assets/images/berhasil.svg') ?>"
                                                        class="img-fluid" alt="fit-image"> </div>
                                            </div>
                                            <br><br>
                                            <div class="row justify-content-center">
                                                <div class="text-center col-7">
                                                    <!-- <h5 class="text-center purple-text">silahkan kembali ke halaman
                                                        buku!!
                                                    </h5> -->
                                                    <a href="<?= base_url('buku/tambah') ?>">

                                                        <button type="button" class="btn btn-success">Ulangi</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- <fieldset>
                                        <div class="form-card">
                                            ...
                                            <br><br>
                                            <h2 class="text-center text-primary"><strong> BERHASIL MENAMBAHKAN
                                                    BUKU!</strong></h2>
                                            <br>
                                            <div class="row justify-content-center">
                                                <div class="col-3"> <img
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        ...
                        <div class="btn btn-border" data-setting="color-mode" data-name="color" data-value="dark">
                            <i class="fa-reguler fa-solid fa-moon fa-flip-horizontal"></i>
                            <span class="ms-2 "> </span>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="mt-4 mb-3">Pilih Tema</h5>
                    ...
                    <div class="btn btn-border bg-transparent" data-value="theme-color-blue" data-info="#573BFF"
                        ...
                        <img src="<?= base_url('assetsAdmin/images/dashboard/smg.jpg') ?>" alt="Your Image Description"
                            style="width: 100%; height: 100%; object-fit: cover;">

                        <!-- Example: using a local image -->
                        <!-- <img src="local-image.png" alt="Your Image Description" style="width: 100%; height: 100%; object-fit: cover;"> -->
                    </div>
                    ...
                    <div class="btn btn-border bg-transparent" data-value="theme-color-gray" data-info="#FD8D00"
                        ...
                        <img src="<?= base_url('assetsAdmin/images/dashboard/dirga.jpg') ?>"
                            alt="Your Image Description" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div class="btn btn-border bg-transparent" data-value="theme-color-red" data-info="#366AF0"
                        data-setting="color-mode1" data-name="color" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="" data-bs-original-title="Theme-3">
                        <img src="<?= base_url('assetsAdmin/images/dashboard/toler.jpg') ?>"
                            alt="Your Image Description" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                ...
                <div class="d-grid gap-3 grid-cols-2 mb-4">
                    ...
                    <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
                        ...
                        <span class=""> Gelap </span>
                    </div>
                    <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
                        data-value="sidebar-color">
                        <span class=""> Berwarna </span>
                    </div>

                    <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color"
                        data-value="sidebar-transparent">
                        <span class=""> Transparan </span>
                    </div>
                </div>
                <hr class="hr-horizontal">
                ...
                <div class="d-grid gap-3 grid-cols-3 mb-4">
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/03.png" alt="mini"
                        ...
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/03.png" alt="mini"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-mini">
                        <span class="mt-2">Mini</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/04.png" alt="hover"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/04.png" alt="hover"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                        <span class="mt-2">Hover</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/05.png" alt="boxed"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-boxed">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/05.png" alt="boxed"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-type" data-value="sidebar-boxed">
                ...
                <div class="d-grid gap-3 grid-cols-2 mb-4">
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/06.png" alt="rounded-one-side"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-rounded">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/06.png" alt="rounded-one-side"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-rounded">
                        <span class="mt-2">Rounded One Side</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/07.png" alt="rounded-all"
                        ...
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/07.png" alt="rounded-all"
                            class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                            data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                        <span class="mt-2">Rounded All</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/08.png" alt="pill-one-side"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-pill">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/09.png" alt="pill-one-side"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-pill">
                        <span class="mt-2">Pill One Side</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/09.png" alt="pill-all"
                        ...
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/08.png" alt="pill-all"
                ...
                <div class="d-grid gap-3 grid-cols-2 ">
                    <div class=" text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/11.png" alt="image"
                        ...
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/10.png" alt="image"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                        <span class="mt-2">Glass</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/10.png" alt="color"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/11.png" alt="color"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                        <span class="mt-2">Color</span>
                    </div>
                    <div class=" text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/12.png" alt="sticky"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/12.png" alt="sticky"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                        <span class="mt-2">Sticky</span>
                    </div>
                    <div class="text-center">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/dark/13.png" alt="transparent"
                            class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                        <img src="<?= base_url('assetsAdmin/') ?>images/settings/light/13.png" alt="transparent"
                            class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                            data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
    ...
    <script src="<?= base_url('assetsAdmin/') ?>js/core/libs.min.js"></script>

    <!-- External Library Bundle Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/core/external.min.js"></script>

    <!-- Widgetchart Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/charts/widgetcharts.js"></script>

    <!-- mapchart Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/charts/vectore-chart.js"></script>
    <script src="<?= base_url('assetsAdmin/') ?>js/charts/dashboard.js"></script>

    <!-- fslightbox Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="<?= base_url('assetsAdmin/') ?>js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->

    <!-- App Script -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.js"></script>
    <script src="<?= base_url('assetsAdmin/') ?>js/hope-ui.js" defer></script>
    <script src="<?= base_url('assets/boot/js/bootstrap.bundle.min.js') ?>"></script>
    ...
    <script>
        function previewImage() {
            ...
            var fileInput = document.getElementById('sampul');
    ...
    <script>
        // Buat objek Date untuk mendapatkan informasi tanggal dan waktu saat ini
        const currentDate = new Date();

        // Daftar nama hari dalam bahasa Indonesia
        const daysOfWeek = ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"];

        // Ambil nama hari berdasarkan indeks hari pada objek Date
        ...
        // Ganti teks pada elemen dengan ID dateText
        document.getElementById('dateText').innerText = `Hari : ${currentDay}, ${dayOfMonth}/${month}/${year}`;
    </script>
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const judulInput = document.getElementById("Judul");
            const kategoriSelect = document.querySelector("select[name='Kategori']");
            const jumlahHalamanInput = document.querySelector("input[name='JumlahHalaman']");
            const bahasaInput = document.querySelector("input[name='Bahasa']");
            const JumlahBukuInput = document.querySelector("input[name='JumlahBuku']");
            const penulisInput = document.querySelector("input[name='Penulis']");
            const penerbitInput = document.querySelector("input[name='Penerbit']");
            const tahunterbitInput = document.querySelector("input[name='TahunTerbit']");
            const smallTextJudul = document.querySelector(".text-danger.judul");
            const smallTextKategori = document.querySelector(".text-danger.kategori");
            const smallTextJumlahhalaman = document.querySelector(".text-danger.jumlahhalaman");
            const smallTextPenulis = document.querySelector(".text-danger.penulis");
            const judulDoneText = document.querySelector(".text-success.judul-done");
            const kategoriDoneText = document.querySelector(".text-success.kategori-done");
            const jumlahHalamanDone = document.querySelector(".text-success.jumlahhalaman-done");
            const smallTextPenerbit = document.querySelector(".text-danger.penerbit");
            const smallTextTahunTerbit = document.querySelector(".text-danger.tahunterbit");
            const penulisDoneText = document.querySelector(".text-success.penulis");
            const penerbitDoneText = document.querySelector(".text-success.penerbit-done");
            const tahunterbitDoneText = document.querySelector(".text-success.tahunterbit-done");
            const smallTextBahasa = document.querySelector(".text-danger.bahasa");
            const bahasaTextDone = document.querySelector(".text-success.bahasa-done");
            const smallTextJumlahBuku = document.querySelector(".text-danger.jumlahbuku");
            const jumlahbukuDone = document.querySelector(".text-success.jumlahbuku-done");

            judulInput.addEventListener("input", function () {
                if (judulInput.value.trim() !== "") {
                    smallTextJudul.style.display = "none";
                    judulDoneText.style.display = "inline";
                } else {
                    smallTextJudul.style.display = "inline";
                    judulDoneText.style.display = "none"
                }
            });

            kategoriSelect.addEventListener("change", function () {
                if (kategoriSelect.value !== "") {
                    smallTextKategori.style.display = "none";
                    kategoriDoneText.style.display = "inline";
                } else {
                    smallTextKategori.style.display = "inline";
                    kategoriDoneText.style.display = "none";
                }
            });

            jumlahHalamanInput.addEventListener("input", function () {
                if (jumlahHalamanInput.value.trim() !== "") {
                    smallTextJumlahhalaman.style.display = "none";
                    jumlahHalamanDone.style.display = "inline";
                } else {
                    smallTextJumlahhalaman.style.display = "inline";
                    jumlahHalamanDone.style.display = "none";
                }
            });
            penulisInput.addEventListener("input", function () {
                if (penulisInput.value.trim() !== "") {
                    smallTextPenulis.style.display = "none";
                    penulisDoneText.style.display = "inline";
                } else {
                    smallTextPenulis.style.display = "inline";
                    penulisDoneText.style.display = "none";
                }
            });
            penerbitInput.addEventListener("input", function () {
                if (penerbitInput.value.trim() !== "") {
                    smallTextPenerbit.style.display = "none";
                    penerbitDoneText.style.display = "inline";
                } else {
                    smallTextPenerbit.style.display = "inline";
                    penerbitDoneText.style.display = "none";
                }
            });
            tahunterbitInput.addEventListener("input", function () {
                if (tahunterbitInput.value.trim() !== "") {
                    smallTextTahunTerbit.style.display = "none";
                    tahunterbitDoneText.style.display = "inline";
                } else {
                    smallTextTahunTerbit.style.display = "inline";
                    tahunterbitDoneText.style.display = "none";
                }
            });
            bahasaInput.addEventListener("input", function () {
                if (bahasaInput.value.trim() !== "") {
                    smallTextBahasa.style.display = "none";
                    bahasaTextDone.style.display = "inline";
                } else {
                    smallTextBahasa.style.display = "inline";
                    bahasaTextDone.style.display = "none";
                }
            });
            JumlahBukuInput.addEventListener("input", function () {
                if (JumlahBukuInput.value.trim() !== "") {
                    smallTextJumlahBuku.style.display = "none";
                    jumlahbukuDone.style.display = "inline";
                } else {
                    smallTextJumlahhalaman.style.display = "inline";
                    jumlahbukuDone.style.display = "none";
                }
            });
