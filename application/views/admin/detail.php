...
<body class="  ">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Sampul Buku</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form>
                                ...
                                <div class="new-user-info">
                                    <form action="<?= base_url('buku') ?>">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="lname">PENULIS</label>
                                                <input type="text" class="form-control" name="Penulis"
                                                    value="<?= $buku['Penulis'] ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="lname">PENERBIT</label>
                                                <input type="text" class="form-control" name="Penulis"
                                                    value="<?= $buku['Penerbit'] ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="lname">KATEGORI</label>
                                                <input type="text" class="form-control" name="Kategori"
                                                    value="<?= $buku['Kategori'] ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="lname">JUMLAH</label>
                                                <input type="text" class="form-control" name="JumlahBuku"
                                                    value="<?= $buku['JumlahBuku'] ?>" readonly>
                                            </div>
                                            <div class="form-groupdet col-md-6">
                                                <label class="form-label" for="lname">TAHUN TERBIT</label>
    ...
    <script>
        $(document).ready(function () {
            $('#example').dataTable({
                "lengthMenu": [[5, 10, 15, 20], [5, 10, 20, 50]], // Menentukan opsi jumlah entri per halaman
