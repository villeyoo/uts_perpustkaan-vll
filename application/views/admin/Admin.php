                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <div class="profile-image-container">
                                        <img src="<?= base_url('profile/' . $user['foto']); ?>" alt="User-Profile"
                                            class="profile-image">
                                        <img src="<?= base_url('profile/' . $user['foto']); ?>" alt="User-Profile"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="<?= base_url('dashboard/profile') ?>">Profile</a>
                                    </li>
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div class="buku">
                                                <i class="fa-duotone fa-books fa-2xl"
                                                    style="--fa-primary-color: #1a6eff; --fa-secondary-color: #1a6eff;"></i>
                                            </div>
                                            <?php
                                            $totalBooks = isset ($_SESSION['totalBooks']) ? $_SESSION['totalBooks'] : 0;
                                            ?>
                                            <div class="progress-detail">
                                                <p class="mb-2">BUKU TERDATA</p>
                                                <h4 class="counter">
                                                    <?= $totalBooks; ?>
                                                </h4>
                                            </div>
                            ...
                            <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
                                <div class="pb-4 border-0 card-header">
                                    <div class="p-4 border border-white rounded primary-gradient-card">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h5 class="font-weight-bold">BLU </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="flex-wrap d-flex justify-content-between">
                                            <h2 class="mb-2">Rp 100.000.000.000,00</h2>
                                            <p class="text-info">Saldo anda</p>
                                        </div>
                                    </div>
