...
<head>
    ...
    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="<?= base_url('assetsAdmin/') ?>/vendor/aos/dist/aos.css">
...
<body class="">
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="lokasi" id="locationText">Mengambil informasi lokasi...</p>
                                </div>
                                <div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <div
                                            ...
                                            <img src="<?= base_url('assets/images/dilan.jpg') ?>" alt="User-Profile"
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                            <h4 class="main-title me-2 h4">
                                                <?= isset($user['name']) ? strtoupper($user['name']) : 'Tidak ada nama'; ?>
                                            </h4>

                                            <span class="main-title mb-1"> -
                                                <?= isset($user['kota']) ? strtoupper($user['kota']) : 'Tidak ada nama kota'; ?>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <ul class="list-inline m-0 p-0">
                                    <li class="d-flex mb-2">
                                        ...
                                        <p class="news-detail mb-0">there is a meetup in your city on fryday at 19:00.
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-card grid-cols-3">
                                    <a data-fslightbox="gallery" href="../../assets/images/icons/04.png">
                                        <img src="../../assets/images/icons/04.png"
                                    ...
                                    <a data-fslightbox="gallery" href="../../assets/images/icons/08.png">
                                        <img src="../../assets/images/icons/08.png"
                                            class="img-fluid bg-soft-info rounded" alt="profile-image">
                                    </a>
                                    ...
                                    <a data-fslightbox="gallery" href="../../assets/images/icons/05.png">
                                        <img src="../../assets/images/icons/05.png"
                                            class="img-fluid bg-soft-danger rounded" alt="profile-image">
                                    </a>
                                    <a data-fslightbox="gallery" href="../../assets/images/shapes/04.png">
                                        <img src="../../assets/images/shapes/04.png"
                                            class="img-fluid bg-soft-primary rounded" alt="profile-image">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="user-post">
                                            <a href="javascript:void(0);"><img
                                                    src="../../assets/images/pages/02-page.png" alt="post-image"
                                                    class="img-fluid"></a>
                                        </div>
                                            ...
                                            <ul class="list-inline p-0 m-0">
                                                <li>
                                                    ...
                                                    <div class="d-inline-block w-100">
                                                        <p>Bonbon macaroon jelly beans gummi bears jelly lollipop apple
                                                        </p>
                                                    </div>
                                                </li>
                                                <li>
    ...
    <script src="<?= base_url('assetsAdmin') ?>/vendor/aos/dist/aos.js"></script>

    <!-- App Script -->
    <script src="<?= base_url('assetsAdmin') ?>/js/hope-ui.js" defer></script>

    <script src="<?= base_url('assets/boot/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
    <script>
        // Fungsi untuk menyesuaikan teks berdasarkan lokasi
        function setLocationText(location) {
            var elemenLokasi = document.getElementById('locationText');
            elemenLokasi.innerText = 'Anda berada di kota ' + location;
        }

        // Fungsi untuk menangani kesalahan jika gagal mendapatkan lokasi
        function handleLocationError(error) {
            var elemenLokasi = document.getElementById('locationText');
            elemenLokasi.innerText = 'Gagal mendapatkan informasi lokasi.';
            console.error('Error getting location:', error);
        }

        // Cek apakah browser mendukung geolokasi
        if ("geolocation" in navigator) {
            // Meminta izin dan mendapatkan informasi lokasi
            navigator.geolocation.getCurrentPosition(function (position) {
                // Dapatkan koordinat geografis (latitude, longitude)
                var latitude = position.coords.latitude;
                var longitude = position.coords.longitude;

                // Di sini, Anda dapat menggunakan layanan geolokasi lainnya
                // untuk mendapatkan nama kota berdasarkan koordinat

                // Misalnya, kita hanya menampilkan informasi kota berdasarkan latitude
                if (latitude >= -6 && latitude <= -5) {
                    setLocationText('Semarang');
                } else if (latitude >= -7 && latitude <= -6) {
                    setLocationText('Tasikmalaya');
                } else {
                    setLocationText('Lokasi tidak dikenal');
                }
            }, handleLocationError);
        } else {
            handleLocationError('Geolokasi tidak didukung.');
        }
    </script>
