...
<head>
    ...
    <title>Pintar Literasi | Buku</title>
...
<body class="  ">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <!-- <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="<?= base_url('peminjaman/dataPeminjam') ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name"> Daftar Peminjam </span>
                            </a>

                        </li>
                    </ul> -->
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url('peminjaman/dataPeminjam') ?>"
                            target="_blank">
                            <i class="icon">
                                <i class="fa-duotone fa-bell-on"></i>

                            </i>
                            <span class="item-name">Permintaan Buku<span
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <br>
                        <table class="table" id="example" style="width:100%" height="auto">
                            <thead>
                                <tr class="main-title">
                                    <th class="text-center" scope="col">NO</th>
                                    <th class="text-center" style="width: 15%" scope="col">BUKU ID</th>
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $rak = 1;
                                $letters = range('A', 'Z'); // Create an array of lowercase letters
                                $totalBooks = 0; // Variabel untuk menyimpan jumlah buku
                                
                                foreach ($buku as $bk):
                                    $totalBooks++; // Tambahkan satu ke jumlah buku di setiap iterasi
                                    ?>
                                    ...
                                    <td class="text-center main-title">
                                        <img src="<?= base_url('foto/' . $bk->Foto); ?>">
                                    </td>
                                    <td class="text-center main-title">
                                        <?php echo $bk->Kategori ?>
                                    </td>
                                    <td class="text-center main-title">
                                        <?= $rak . (isset ($letters[$rak - 1]) ? $letters[$rak - 1] : ''); ?>
                                    </td>
                                    <td class="text-center main-title">
                                        <?php echo $bk->JumlahBuku; ?>
                                    </td>

                                    <td class="text-center main-title">
                                        <a href="<?= base_url('buku/detail/' . $bk->bukuID); ?>" class="btn btn-warning">
                                            <i class="fa-regular fa-circle-info" style="color: #000"></i>
                                        </a>

                                        <a href="#" class="btn btn-danger"
                                            onclick="confirmDelete(event, <?= $bk->bukuID ?>)">
                                            <i class="fa-regular fa-trash"></i>
                                        </a>
                                        <a href="#" class="btn btn-primary"
                                            onclick="confirmEdit(event, <?= $bk->bukuID ?>)">
                                    ...
                                    $rak++;
                                endforeach;
                                $_SESSION['totalBooks'] = $totalBooks; // Simpan total buku dalam session
                                ?>
    ...
    <script>
        $(document).ready(function () {
            $('#example').dataTable({
                "lengthMenu": [[5, 10, 20, 50], [5, 10, 20, 50]], // Menentukan opsi jumlah entri per halaman
                ...
                "language": {
                    ...
                    "search": "Cari :",
                    "searchPlaceholder": "Cari Kategori Atau Judul",
                    "paginate": {
                        "first": "<<",
                        "last": ">>",

                    },
                    "emptyTable": 'Tidak ada buku di table'
                }
            });
        });
    </script>
    ...
    <script>
        function confirmEdit(event, bukuID) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('buku/edit/') ?>" + bukuID;
                }
            });
        }
        ...
        function confirmDelete(event, bukuID) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('buku/hapus/') ?>" + bukuID;
                }
            });
        }
    </script>
