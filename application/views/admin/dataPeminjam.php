        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('buku') ?>" aria-expanded="false"
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url('peminjaman/dataPeminjam') ?>">
                            <i class="icon">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <br>
                        <table class="table" id="example" style="width:auto%" height="auto">
                            <thead>
                                <tr class="main-title">
                                    <th class="text-center">NO</th>
                                    <th class="text-center">No Transaksi</th>
                                    <th class="text-center">Nama</th>
                                    <th class="text-center">Buku ID</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    foreach ($peminjam as $pm):
                                        ...
                                        <td class="text-center main-title">
                                            <?php echo $pm->no_transaksi; ?>
                                        </td>
                                        <td class="text-center main-title">
                                            <?php echo strtoupper($pm->nama); ?>
                                        </td>
                                        <td class="text-center main-title">
                                            <?php echo strtoupper($pm->bukuID); ?>
                                        </td>
                                        <td class="text-center main-title">
                                            <?php echo $pm->TanggalPeminjaman ?>
                                        </td>
                                        <td class="text-center main-title">
                                            <?php echo $pm->TanggalPengembalian; ?>
                                        </td>
                                    </tr>
                                    <?php
