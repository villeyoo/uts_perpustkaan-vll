...
<head>
    ...
    <title>Pintar Literasi | Edit</title>
...
<body class="  ">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form-wizard1" class="mt-3 text-center" action="<?= base_url('buku/update') ?>"
                                    method="post" enctype="multipart/form-data">
                                    <ul id="top-tab-list" class="p-0 row list-inline">
                                        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
                                            <a>
                                                <div class="iq-icon me-3">
                                                    <i class="fa-regular fa-input-pipe"></i>
                                                </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-card text-start">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <h2 class="steps text-center">Langkah 1 - 3</h2>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="bukuID" required
                                                            value="<?= $buku['bukuID'] ?>" readonly>
                                                        <div class="invalid-feedback">
                                                        </div>
                                                        <small class="text-danger">Buku ID tidak bisa di rubah</small>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="">
                                                        <div class="mb-3">
                                                            ...
                                                            <small class="text-success judul-done"
                                                                style="display: inline;">Judul sudah terisi
                                                                sebelumnya</small>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="Kategori" required>
                                                            ...
                                                            <option value="Non-Fiksi"
                                                                <?= ($buku['Kategori'] == 'Non-Fiksi') ? 'selected' : '' ?>>Non-Fiksi
                                                            </option>
                                                            <option value="Referensi"
                                                                <?= ($buku['Kategori'] == 'Referensi') ? 'selected' : '' ?>>Referensi
                                                            </option>
                                                            <option value="Sains" <?= ($buku['Kategori'] == 'Sains') ? 'selected' : '' ?>>Sains</option>
                                                            <option value="Horror" <?= ($buku['Kategori'] == 'Horror') ? 'selected' : '' ?>>Horror</option>
                                                            <option value="Romantis" <?= ($buku['Kategori'] == 'Romantis') ? 'selected' : '' ?>>Romantis</option>
                                                            <option value="PengembangDiri"
                                                                <?= ($buku['Kategori'] == 'PengembangDiri') ? 'selected' : '' ?>>Pengembangan Diri</option>
                                                            <option value="Lain-lain"
                                                                <?= ($buku['Kategori'] == 'Lain-lain') ? 'selected' : '' ?>>Lain-lain
                                                            </option>
                                                        </select>
                                                        <small class="text-success">Kategori sudah di pilih
                                                            sebelumnya</small>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Jumlah halaman</label>
                                                        <input type="text" class="form-control" name="JumlahHalaman"
                                                            required value="<?= ($buku['JumlahHalaman']) ?>">
                                                        <div class="invalid-feedback">
                                                        </div>
                                                        <small class="text-success penulis"
                                                            style="display: inline;">Jumlah halaman
                                                            sudah di isi sebelumnya</small>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="text-success penulis"
                                                            style="display: inline;">Bahasa Buku
                                                            sudah di isi sebelumnya</small>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="JumlahBuku"
                                                            ...
                                                            value="<?= $buku['JumlahBuku'] ?>">
                                                        <div class="invalid-feedback">
                                                            Masukan angka!!!
                                                        </div>
                                                        <small class="text-success">Jumlah Buku sudah di isi
                                                            sebelumnya</small>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-card text-start">
                                            <div class="row">
                                                <div class="col-7">
                                                    <h3 class="mb-4 text-danger">Edit Informasi Penulis:</h3>
                                                </div>
                                                <div class="col-5">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-success penulis" style="display: inline;">Penulis
                                                        sudah di isi sebelumnya</small>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-success penerbit">Penerbit sudah di isi
                                                        sebelumnya</small>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-success tahunterbit">Tahun Terbit sudah di isi
                                                        sebelumnya</small>
                                        ...
                                        <button type="submit" name="next"
                                            class="btn btn-primary next action-button float-end" value="Next">Update
                                            data</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const smallTextJumlah = document.querySelector(".text-danger.jumlah");
            ...
            const jumlahDoneText = document.querySelector(".text-success.jumlah-done");
            ...
            jumlahInput.addEventListener("input", function () {
                if (jumlahInput.value.trim() !== "") {
                    smallTextJumlah.style.display = "none";
                    jumlahDoneText.style.display = "inline";
                } else {
                    smallTextJumlah.style.display = "inline";
                    jumlahDoneText.style.display = "none";
                }
            });
